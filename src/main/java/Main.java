...
public class Main {
    public static void main(String[] args) throws IOException, ListIsEmptyException {
        ...
        Players player4 = new Players("pedro", Teams.Sparks, 3);
        Players player5 = new Players("jose", Teams.Giants, 4);
        ...
        GameSettingsPortal gameSettingsPortal1 = new GameSettingsPortal(100, 200, player1);
        GameSettingsPortal gameSettingsPortal2 = new GameSettingsPortal(150, 300, player2);
        GameSettingsPortal gameSettingsPortal3 = new GameSettingsPortal(200, 400, player3);
